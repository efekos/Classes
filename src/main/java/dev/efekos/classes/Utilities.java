...
public final class Utilities {
    public static Material getMaterialByKey(String key) {
        for (Material material : Material.values()) {
            if (Objects.equals(key, material.getKey().getNamespace() + ":" + material.getKey().getKey()))
                return material;
        }
        return null;
    }
    ...
    public static Enchantment getEnchantmentByKey(String key) {
        for (Enchantment enchantment : Enchantment.values()) {
            if (Objects.equals(key, enchantment.getKey().getNamespace() + ":" + enchantment.getKey().getKey()))
                return enchantment;
        }
        return null;
    }
