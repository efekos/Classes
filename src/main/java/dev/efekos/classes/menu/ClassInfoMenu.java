...
public class ClassInfoMenu extends Menu {
    ...
    public void fill() {
        ...
        if(ownClass) inventory.setItem(39,createItem(Material.RED_DYE,translateColors(Main.LANG.getString("menus.class_info.leave","&cLeave Class"))));
        else if(!hasClass) inventory.setItem(41,createItem(Material.LIME_DYE,translateColors(Main.LANG.getString("menus.class_info.join","&aJoin This Class"))));
